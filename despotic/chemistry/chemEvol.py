...
def chemEvol(cloud, tFin, tInit=0.0, nOut=100, dt=None, \
    ...
    # initialize it and associate it with the cloud; if not, make sure
    # the cloud has a network associated with it before proceeding.
    ...
    if tOut1[-1] < tFin:
        odeint(cloud.chemnetwork.dxdt, cloud.chemnetwork.x,
